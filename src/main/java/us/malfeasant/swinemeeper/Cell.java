...
/**
 * A Cell possibly holds a mine, keeps track of its neighbors. Contains a
 * button.
 *
 * @author Malfeasant
 *
...
public class Cell {
    ...
    private static final String SPACE = "\u2003";	// fat space
    private static final String FLAG = "\u2691";	// 1f6a9?
    private static final String WRONG = "X";
    private static final String BOMB = "\ud83d\udca3";	// 1f4a3?
    ...
    void action(MouseButton b) {
        ...
        // middle clicks, anything else ignored...
    }
